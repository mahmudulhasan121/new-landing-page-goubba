...
const resources = {
  en: {
    translation: {
		...
		"explore_possibilities_txt": "We bring together everything that's required to set up rewards, incentives and payouts, for your employees, partners, and customers",
		"employees": "Employees",
		"emplyees_txt": "We help create tailored engagement programs that deliver rewards across all Algeria",
		"customers": "Customers",
		"customers_txt": "We help distribute omni-channel campaigns using out of the box integrations",
		"partners": "Partners",
		"partners_txt": "Our platform helps keep the channels flexible to meet the requirements of an evolving ecosystem",
		"huge_flexibility": "Huge flexibility & Tons of discounts by unlocking PRO membership for your employees.",
		"fullstack_solution": "Goubba is a full-stack embedded solution",
		"fullstack_solution_txt": "Build your solution piece by piece with a modular API that lets you integrate new features as you scale",
		"incentives": "Incentives",
		"incentives_txt": "Everything you need to build a program that can send rewards and incentives globally",
		"benefits": "Benefits",
		"benefits_txt": "Offer a tailored benefit plan for your employees with one stand-alone solution",
		"catalogue": "Catalogue",
		"catalogue_txt": "Integrate direct real-time connectivity to every major branded Gift Card across Algeria",
		"payouts": "Payouts",
		"payouts_txt": "Pay instantly your employees, customers, and partners with Goubba Gift Cards",
  ...
  fr: {
    translation: {
		...
		"top-up_and_transfer": "Rechargez et Transférez des Goubba Credits instantanément !",
		...
		"reward_employees": "Récompenser et Encourager vos employés n'aura jamais été aussi facile",
		...
		"explore_possibilities_txt": "Nous réunissons tout le nécessaire pour mettre en place des récompenses et des incitations pour vos employés, vos partenaires et vos clients",
		"employees": "Employés",
		"emplyees_txt": "Nous vous aidons à créer des programmes de motivation sur mesure qui permettent d'offrir des récompenses à travers toute l'Algérie.",
		"customers": "Clients",
		"customers_txt": "Nous aidons à diffuser des campagnes omnicanales en utilisant des intégrations originales",
		"partners": "Partenaires",
		"partners_txt": "Notre plateforme permet de maintenir la flexibilité des canaux pour répondre aux exigences d'un écosystème en constante évolution.",
		"huge_flexibility": "Une énorme flexibilité et des tonnes de réductions en débloquant l'abonnement PRO pour vos employés.",
		"fullstack_solution": "Goubba est une solution entièrement intégrée.",
		"fullstack_solution_txt": "Construisez votre solution grâce à une API modulaire qui vous permet d'intégrer de nouvelles fonctionnalités à mesure que vous évoluez",
		"incentives": "Récompenses",
		"incentives_txt": "Tout ce dont vous avez besoin pour créer un programme permettant d'envoyer des récompenses et des incitations à l'échelle mondiale",
		"benefits": "Avantages",
		"benefits_txt": "Offrez un régime d'avantages sur mesure à vos employés avec une seule solution autonome",
		"catalogue": "Catalogue",
		"catalogue_txt": "Intégrer une connectivité directe en temps réel à toute marque de cartes-cadeaux en Algérie",
		"payouts": "Paiement",
		"payouts_txt": "Payez instantanément vos employés, clients et partenaires avec les cartes-cadeaux Goubba",
		"send_track": "Un suivi complet des récompenses pour une maitrise totale des coûts",
		"send_now": "Envoyez-les maintenant",
		"coming_soon": "Bientôt disponible",
		"schedue_send": "Ne manquez jamais les événements importants",
		"unsend_rewadrs": "Nous vous remboursons instantanément votre argent inutilisé sur votre compte.",
		"check_more":"Voir plus"
    }
  }
};
