...
function landingPageAbout() {
  return (
    <>
      ...
      <div className="tw-py-28 lg:tw-py-32 lg:tw-px-16 tw-gap-16 tw-flex tw-flex-col tw-text-white tw-bg-gradient-to-b tw-from-[#292526] tw-to-[#750665]">
        {/* -------------------------------------------------------- 1. Our mission ---------------------------------------------------*/}

        <div className="tw-text-left tw-flex tw-flex-col tw-gap-4 tw-px-4">
          <H1 text={data.mission.title} />
          <Text text={data.mission.description} />
          <div className="tw-flex-col tw-flex tw-gap-8 md:tw-gap-2 md:tw-flex-row">
        ...
        <div className="tw-text-left tw-flex tw-flex-col tw-gap-3 tw-px-3">
      ...
      <div className="tw-py-10 lg:tw-py-20 lg:tw-px-16 tw-gap-10 lg:tw-gap-16 tw-flex tw-flex-col tw-text-[#531A5B] tw-bg-[#FFFBFC]">
        {/* -------------------------------------------------------- 3. Who are We ? (question) ---------------------------------------------------*/}

        <div className="tw-text-left tw-flex tw-flex-col tw-px-4 tw-gap-4">
        ...
        <div className="tw-text-left tw-flex tw-flex-col tw-px-4 tw-gap-4">
          ...
          <div>
            <img
              ...
              alt="Team Member"
              className="tw-w-full tw-h-auto tw-mb-3 tw-rounded-md lg:tw-rounded-2xl"
            />

            {/* image album for Web & tablet */}
            <div className="tw-hidden tw-gap-4 md:tw-grid md:tw-grid-cols-3 tw-w-full">
      ...
      <div className="tw-py-7 tw-pb-10 tw-px-4 lg:tw-py-12 lg:tw-px-40 tw-flex tw-flex-col tw-gap-1 lg:tw-gap-3 tw-text-[#531A5B] tw-bg-[#FFF3FE]">
        <div>
