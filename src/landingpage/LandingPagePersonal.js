          ...
          <div className='mt-28 overflow-y-hidden '>
            <Parallax className='' 
              ...
              <div className='flex gap-4'>
                ...
                <img src={Amazon} classN className="w-24 h-32 rounded-lg" />
              </div>
            </Parallax>
            <Parallax className='' 
                translateY={[60, -60]}
          ...
          <div className='mt-32 overflow-y-hidden '>
            <Parallax className='' 
              ...
              <div className='flex gap-4'>
                ...
                <img src={Amazon}  className="w-28  rounded-lg" />
              </div>
            </Parallax>
            <Parallax className='' 
                translateY={[60, -60]}
          ...
          <div className='mt-36 overflow-hidden no-scrollbar '>
            <Parallax className='' 
              ...
              <div className='flex gap-4'>
                ...
                <img src={Amazon} className="w-[135px]  rounded-lg " />
              </div>
            </Parallax>
            <Parallax className='' 
                translateY={[30, -50]}
          ...
          <div className='mt-28  no-scrollbar overflow-y-hidden'>
            <Parallax className='' 
              ...
              <div className='flex gap-3'>
                ...
                <img src={Amazon} className="w-[185px] rounded-lg " />
              </div>
            </Parallax>
            <Parallax className='' 
                translateY={[30, -50]}
...
function DownloadButtons(){
    ...
    "Windows OS";
  if (navigator.userAgent.indexOf("HUAWEI") != -1) Name = 
    "HUAWEI";
    ...
    <div className='flex gap-4 justify-center items-center my-4'>
     { 
      navigator.userAgent.indexOf("HUAWEI") != -1
        ?<a href='https://appgallery.huawei.com/app/C105229305' className='flex justify-center
                  items-center text-left px-2 '>
            <img src={HUAWEI}></img>
          </a>
      :navigator.userAgent.indexOf("like Mac") != -1
      ?<a href='https://apps.apple.com/us/app/goubba-cashback-codes-promo/id1519941116' className='flex justify-center
              items-center  '>
          <img src={ios}></img>
        </a>
      :navigator.userAgent.indexOf("Android") != -1
      ?<a href='https://goubba.app.link/Goubba_App' className='flex justify-center'>
  ...
  return (
    <div>
      <main className=''>
        ...
        <div className='lg:w-9/12 mx-4 lg:mx-auto mt-24'>
          <div className='flex justify-center text-center'>
            <div className='mb-12'>
              <h2 className='text-[#021E27] font-medium text-xl lg:text-[48px] lg:mb-8'>
                Join over 5 millions Goubists
              </h2>
              <h2 className='text-[#021E27] font-medium text-xl lg:text-[48px] mb-8 '>
                saving and winning rewards
              </h2>
            </div>
          </div>
          <div className='  gap-3 lg:gap-8 
                          lg:grid  lg:grid-cols-2
                          flex lg:flex-none overflow-auto no-scrollbar'>
        ...
        <div className='mt-28 w-11/12 lg:w-9/12 mx-auto'>
          <h2 className='text-[#021E27] font-medium text-xl lg:text-[48px]'>Our Partners</h2>
          <div className='hidden xl:flex items-center justify-center my-12 gap-2 '>
            <img src={technoC} className='w-52 rounded-lg'>
            </img>
            <img src={scechersC} className='w-52 rounded-lg'>
            </img>
            <img src={cazanimoC} className='w-52 rounded-lg'>
            </img>
            <img src={footlandC} className='w-52 rounded-lg'>
            </img>
            <img src={profootC} className='w-52 rounded-lg'>
            </img>
            <img  src={camperC} className='w-52  rounded-lg'>
            </img>
          ...
          <div className='flex justify-center '>
            <a href='https://stage.goubba.com/cards' className='bg-[#FFF6FC]  flex justify-center items-center px-6 py-2 gap-4 rounded-lg text-pink-600 group'>
              <p className='font-semibold'>Explore Gift Card Partners</p>
              <svg className='w-8 group-hover:translate-x-2 duration-800 transition' viewBox="0 0 30 31" fill="#BA1986" xmlns="http://www.w3.org/2000/svg">
                <rect opacity="0.3" x="6.25" y="16.75" width="2.5" height="17.5" rx="1" transform="rotate(-90 6.25 16.75)" fill="#BA1986"/>
                <path d="M14.1161 22.1161C13.628 22.6043 13.628 23.3957 14.1161 23.8839C14.6043 24.372 15.3957 24.372 15.8839 23.8839L23.3839 16.3839C23.8571 15.9107 23.8737 15.1487 23.4214 14.6553L16.5464 7.15534C16.08 6.64644 15.2892 6.61207 14.7803 7.07856C14.2714 7.54505 14.2371 8.33576 14.7036 8.84466L20.7698 15.4624L14.1161 22.1161Z" fill="#BA1986"/>
              </svg>
            </a>
          </div>
        </div>
            ...
            <div className='flex items-center'>
              <div>
                <p className='text-xl text-center lg:text-left lg:text-5xl lg:leading-[52px] font-medium mb-10 lg:w-2/3'>
                  Share our exclusive gift cards, offers and deals with your friends and family
                </p>
                <div className='flex justify-center lg:justify-start'>
                  <a href='https://goubba.app.link/Goubba_App' className='group bg-[#FFF6FC] flex justify-center items-center px-6 py-2 gap-4 rounded-lg text-pink-600'>
          ...
          <div className='grid grid-flow-row lg:grid-cols-2 mt-28 w-10/12 mx-auto'>
            <div className='flex items-center order-3 lg:order-1 '>
              <div>
                ...
                <div className='flex justify-center lg:justify-start'>
                  <a href='https://partner.goubba.com' className='group bg-[#FFF6FC] flex justify-center items-center px-6 py-2 gap-4 rounded-lg text-pink-600'>
        ...
        <div className='bg-[#FFFBFC]'>
          <div className='grid grid-flow-row lg:grid-cols-2 mt-28 w-10/12 mx-auto'>
            ...
            <div className='flex items-center'>
              <div>
                <p className='text-xl text-center lg:text-left lg:text-5xl lg:leading-[52px] font-medium mb-10 lg:w-2/3'>
                  Top up & transfer Goubba credits instantly & securely to earn rewards and win prizes.
                </p>
                <div className='flex justify-center lg:justify-start'>
                  <a href='https://stage.goubba.com/topup' className='group bg-[#FFF6FC] flex justify-center items-center px-6 py-2 gap-4 rounded-lg text-pink-600'>
        ...
        <div className='retropurple-background lg:mx-12 lg:mb-12 lg:rounded-xl py-20 lg:py-44'>
          <div>
            ...
            <div className='flex justify-center mt-12 lg:mt-24'>
              <NavLink  to='./business' className='group bg-white bg-opacity-20 backdrop-blur-lg    
                      flex justify-center items-center px-16 py-2 gap-4 rounded-lg text-[#700F50]'>
                <p className='font-semibold'>Try it</p>
                <svg className='w-8 group-hover:translate-x-2 duration-800 transition' viewBox="0 0 30 31" fill="#700F50" xmlns="http://www.w3.org/2000/svg">
                  <rect opacity="0.3" x="6.25" y="16.75" width="2.5" height="17.5" rx="1" transform="rotate(-90 6.25 16.75)" fill="#700F50"/>
